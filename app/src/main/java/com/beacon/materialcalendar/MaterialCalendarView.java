...
import com.beacon.materialcalendar.format.ArrayWeekDayFormatter;
import com.beacon.materialcalendar.format.DateFormatTitleFormatter;
import com.beacon.materialcalendar.format.DayFormatter;
import com.beacon.materialcalendar.format.MonthArrayTitleFormatter;
import com.beacon.materialcalendar.format.TitleFormatter;
import com.beacon.materialcalendar.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Default tile size in DIPs. This is used in cases where there is no tile size specificed and the view is set to
        ...
        if (adapter != null && state.cacheCurrentPosition) {
            ...
            if (calendarMode != state.calendarMode) {
                ...
                if (calendarMode == CalendarMode.MONTHS && currentlySelectedDate != null) {
                    ...
                    boolean b = currentlySelectedDate.equals(calendarDayToShow) ||
                    ...
                    CalendarDay lastVisibleCalendarDay = CalendarDay.from(lastVisibleCalendar);
                    boolean b = currentlySelectedDate != null &&
